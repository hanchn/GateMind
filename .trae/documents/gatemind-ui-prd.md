...
| 连接申请页 | 申请表单 | 填写连接名称、数据库类型、用途、业务域、权限范围 |
| 连接申请页 | 申请记录 | 展示申请状态、审批链路、驳回原因 |
| 库表治理页 | 库表列表 | 展示库、表、字段敏感级别、纳管状态和操作入口 |
| 库表治理页 | 治理面板 | 支持标记敏感字段、配置脱敏、模拟新增删除操作 |
